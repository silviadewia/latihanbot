...
<head>
    ...
    <title>Pengunjung Chating Bot</title>
...
<div class="container d-flex justify-content-center">
    <div class="card mt-5">
        ...
        <form action="bot.php" method="POST">
            ...
            <input type="hidden" name="pengirim" id="pengirim" value="silvi">
            ...
            while ($data = mysqli_fetch_array($query_mysql)) {
                ...
                {
            ?>
                    <div class="d-flex flex-row p-3"> <img src="img/bot.png" width="30" height="30">
                ...
                ?>
                    <div class="d-flex flex-row p-3">
                        ...
                        </div> <img src="img/person.png" width="30" height="30">
                    </div>
